 ...
 import { Eye, Users, Heart, ChevronRight, ArrowLeft, Share2 } from "lucide-react";
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           ...
           <div className="lg:col-span-2">
             ...
             <div className="bg-muted rounded-lg p-4 mb-6 flex items-center justify-between">
               <div>
                 <span className="text-primary font-semibold">Read 5 new episodes only on the app!</span>
           ...
           <div className="lg:col-span-1">
             ...
             <div className="mb-6">
               ...
               <p className="text-sm text-muted-foreground mt-4 italic">
                 This series is rated Young Adult. Please review the Content Ratings page for more
                 information.
               </p>
             </div>
