 ...
 const newComics = [
   { id: 1, title: "Moonlit Shadows", genre: "Fantasy", image: comic1, isNew: true },
   { id: 2, title: "City of Secrets", genre: "Thriller", image: comic3, isNew: true },
   { id: 3, title: "Love Algorithm", genre: "Romance", image: comic6, isNew: true },
   { id: 4, title: "Power Surge", genre: "Action", image: comic4, isNew: true },
   { id: 5, title: "Campus Days", genre: "Slice of life", image: comic7, isNew: true },
