 ...
 const scheduleByDay: Record<string, { id: number; title: string; genre: string; image: string; isNew?: boolean }[]> = {
   SUN: [
     { id: 1, title: "Tower of God", image: comic1, genre: "Fantasy", isNew: true },
   ...
   TUE: [
     { id: 1, title: "Solo Leveling", image: comic4, genre: "Action", isNew: true },
   ...
   WED: [
     { id: 1, title: "Omniscient Reader", image: comic1, genre: "Fantasy", isNew: true },
   ...
   FRI: [
     { id: 1, title: "Hardcore Leveling", image: comic4, genre: "Action", isNew: true },
   ...
   SAT: [
     { id: 1, title: "Gangnam Beauty", image: comic10, genre: "Romance", isNew: true },
