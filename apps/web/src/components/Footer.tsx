...
const Footer = () => {
  return (
    <footer className="border-t border-black/5 bg-[#F9F9F9] py-16 text-[#181818] transition-colors duration-300 dark:border-white/5 dark:bg-[#0A0A0A] dark:text-white">
