...
export const comics: Comic[] = [
  ...
  },
  {
    ...
    episodes: generateEpisodes(120, [comic7, comic4]),
  },
  {
    id: 9,
    ...
    image: comic8,
    banner: webtoonBanner,
    description: "Dokja was an average office worker whose sole interest was reading his favorite web novel. But when the novel becomes reality, he is the only person who knows how the world will end.",
    author: "singNsong",
    views: "25.1M",
    subscribers: "1.2M",
    rating: 9.9,
    updateDay: "EVERY WEDNESDAY",
    episodes: generateEpisodes(180, [comic8, comic2]),
  },
  {
    id: 10,
    slug: "tower-of-god",
    ...
    rating: 9.8,
    updateDay: "EVERY MONDAY",
    episodes: generateEpisodes(550, [comic9, comic10]),
  },
  {
    id: 11,
    slug: "solo-leveling",
    ...
    image: comic10,
    banner: webtoonBanner,
    description: "In a world where hunters must battle deadly monsters, Sung Jinwoo is the weakest of them all. But after a mysterious incident, he gains the ability to level up alone.",
    author: "Chugong",
    views: "38.5M",
    subscribers: "2.8M",
    rating: 9.9,
    updateDay: "EVERY THURSDAY",
    episodes: generateEpisodes(179, [comic10, comic1]),
  },
  {
    id: 12,
    slug: "lookism",
    ...
    image: comic1,
    banner: webtoonBanner,
    description: "A high school student who is bullied for his appearance wakes up one day in a completely different, handsome body.",
    author: "Park Tae-jun",
    views: "18.2M",
    subscribers: "950,000",
    rating: 9.7,
    updateDay: "EVERY FRIDAY",
    episodes: generateEpisodes(450, [comic1, comic4]),
  },
  {
    id: 13,
    ...
    genre: "Romance",
    image: comic2,
    description: "A skilled doctor from modern times is reincarnated into the past and uses her medical knowledge to survive.",
    author: "Flower Tea",
    views: "5.4M",
    subscribers: "120,000",
    rating: 9.4,
    updateDay: "EVERY TUESDAY",
    episodes: generateEpisodes(80, [comic2, comic6]),
  },
  {
    id: 14,
    slug: "urban-shadow",
    ...
    genre: "Thriller",
    image: comic3,
    description: "A private investigator uncovers a series of supernatural murders in the heart of the city.",
    author: "J.D. Night",
    views: "4.1M",
    subscribers: "85,000",
    rating: 9.2,
    updateDay: "EVERY SATURDAY",
    episodes: generateEpisodes(35, [comic3, comic7]),
  },
  {
    id: 15,
    ...
    genre: "Action",
    image: comic4,
    description: "The world's top player in a virtual reality game loses everything and decides to start over from level 1.",
    author: "Cyber Punk",
    views: "9.8M",
    subscribers: "310,000",
    rating: 9.6,
    updateDay: "EVERY SUNDAY",
    episodes: generateEpisodes(95, [comic4, comic8]),
  }
];
